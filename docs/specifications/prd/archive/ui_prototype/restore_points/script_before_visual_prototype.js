(() => {
  ...
  function applyPatientListFilter(filterType, filterValue = null) {
    // Use static patientListData (working approach)
  ...
  function initPatientList() {
    ...
    // Initial render with static patient list data (working approach)
    renderPatientList();
  }
  ...
  function refreshDashboard() {
    // Refresh patient list with static data (working approach)
    renderPatientList();
    
    // Refresh active searches
    renderActiveSearches();
    
    console.log('Dashboard refreshed with', patientListData.length, 'patients');
  }
  ...
  const renderPatientList = (filteredData = null) => {
    ...
    // Use filtered data or default patientListData (working approach)
    ...
    console.log('Patient list rendered with', data.length, 'patients');
  };
  ...
  function setupPatientRowEvents(row, patient) {
    ...
    // Row enter/click
    row.addEventListener('click', () => handlePatientRowEnter(patient));
    row.addEventListener('keydown', (e) => {
      if (e.key === 'Enter') {
        handlePatientRowEnter(patient);
      }
