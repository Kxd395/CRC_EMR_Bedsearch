...
export const newPatientScenarios = [
  {
    ...
    note: {
      ...
      matNeeds: { type: 'MethadoneContinue', status: 'active' },
      placementNeeded: 'Y',
      commitment: '302Hold',
    ...
    searches: [
      {
        ...
        events: [
          {
            id: 'evt_1727154000000_initial',
            search_id: 'pt_501-01',
            ts: '2025-09-24T09:00:00Z',
            user_id: 'mlee',
            type: 'call_outcome',
          ...
          {
            id: 'evt_1727154300000_docs',
            search_id: 'pt_501-01', 
            ts: '2025-09-24T09:05:00Z',
            user_id: 'mlee',
            type: 'docs_sent',
            payload: { docs: ['clinical_packet', 'tox_results'] },
            version: 2
          },
          {
            id: 'evt_1727157600000_accept',
            search_id: 'pt_501-01',
            ts: '2025-09-24T10:00:00Z',
            user_id: 'eagleville_admin',
            type: 'acceptance',
            payload: { hold_until: '2025-09-24T17:00:00Z' },
            version: 3
          },
          {
            id: 'evt_1727158500000_transport',
            search_id: 'pt_501-01',
            ts: '2025-09-24T10:15:00Z',
            user_id: 'mlee',
            type: 'transport_scheduled',
            payload: { pickup_at: '2025-09-24T16:30:00Z' },
            version: 4
          }
        ]
      }
  ...
  },
  {
    ...
    note: {
      ...
      matNeeds: { type: 'SuboxoneInduction', status: 'pending' },
      placementNeeded: 'Y',
    ...
    searches: [
      {
        ...
        events: [
          {
            id: 'evt_1727151000000_abc123',
            search_id: 'pt_502-01',
            ts: '2025-09-24T08:30:00Z',
            user_id: 'cchen',
            type: 'call_outcome',
            payload: { outcome: 'no_beds', recheck_time: '14:00' },
            version: 1
          }
        ]
      }
  ...
  },
  {
    ...
    note: {
      ...
      matNeeds: { type: 'MethadoneInduction', status: 'pending' },
      placementNeeded: 'Y',
      commitment: '302Hold',
  ...
  },
  {
    ...
    note: {
      ...
      matNeeds: { type: 'SuboxoneContinue', status: 'active' },
      placementNeeded: 'Y',
      commitment: 'Voluntary',
      acuity: 'High-Intensity Residential',
