...
export const facilityDirectory = [
  // ========== INPATIENT PSYCHIATRIC HOSPITALS ==========
  {
    ...
    email: '',
    website: null,
    services: ['302 Accepted', 'CBH Insurance'],
    capabilities: {
      takes302: true,
      secureBh: false,
      acuteMed: false,
    ...
    contacts: {
      admissions: '(215) 481-5450',
      nursing: null,
      socialWork: null,
      medical: null
    },
    notes: 'Accepts 302 involuntary commitments, CBH insurance',
    tags: ['302 Accepted', 'CBH Insurance']
  },
  {
    id: 'GIRARD_BWC',
    name: 'Behavioral Wellness Center at Girard',
    category: 'Psychiatric Hospital',
    level: 'Inpatient Psychiatric',
    address: '801 West Girard Ave',
    city: 'Philadelphia',
    state: 'PA',
    zip: '19122',
    phone: '(215) 787-2018',
  ...
  {
    id: 'BELMONT',
    name: 'Belmont Behavioral Health',
    category: 'Psychiatric Hospital',
    level: 'Inpatient Psychiatric',
    ...
    email: null,
    website: null,
    services: ['Dual Diagnosis', 'Inpatient Psychiatric Hospital', '302 Accepted'],
    capabilities: {
      takes302: true,
      secureBh: true,
      acuteMed: false,
    ...
    notes: 'Specializes in dual diagnosis treatment, accepts 302',
    tags: ['Dual Diagnosis', 'Psychiatric Hospital', '302 Accepted']
  },
  {
    id: 'BROOKE_GLEN',
  ...
  // ========== ADDITIONAL SUBSTANCE ABUSE TREATMENT FACILITIES ==========
  {
    ...
    name: 'Beacon Point',
    category: 'Treatment Center',
    level: 'Substance Abuse Treatment',
    address: null,
    city: null,
    state: 'PA',
    zip: null,
    ...
    contacts: {
      admissions: '(267) 966-2080',
      nursing: null,
      socialWork: null,
      medical: null
    },
    notes: 'Rehab level 3.5B substance abuse treatment',
    tags: ['3.5B', 'Rehab', 'Substance Abuse']
  },
  {
    id: 'GAUDENZIA',
    name: 'Gaudenzia',
    ...
    notes: 'Detox level 3.7A substance abuse treatment',
    tags: ['3.7A', 'Detox', 'Substance Abuse']
  },
  {
    id: 'GIRARD',
    name: 'Girard',
    ...
    email: null,
    website: null,
    services: ['Detox 3.7A', 'Rehab 3.5B'],
    capabilities: {
      takes302: false,
      secureBh: false,
      acuteMed: false,
    ...
    contacts: {
      admissions: '(215) 787-2196',
      nursing: null,
      socialWork: null,
      medical: null
    },
    notes: 'Detox 3.7A and Rehab 3.5B substance abuse treatment',
    tags: ['3.7A', '3.5B', 'Detox', 'Rehab', 'Substance Abuse']
  },
  {
    id: 'KENSINGTON',
    name: 'Kensington',
    ...
    email: null,
    website: null,
    services: ['Detox 3.7A', 'Detox 4.0A', 'Rehab 3.5B'],
    capabilities: {
      takes302: false,
      secureBh: false,
      acuteMed: false,
    ...
    contacts: {
      admissions: '(215) 426-8100',
      nursing: null,
      socialWork: null,
      medical: null
    },
    notes: 'Multiple LOC levels: Detox 3.7A, 4.0A and Rehab 3.5B',
    tags: ['3.7A', '4.0A', '3.5B', 'Detox', 'Rehab', 'Substance Abuse']
  },
  {
    id: 'KEYSTONE_CENTER',
  ...
  },
  {
    ...
    contacts: {
      admissions: '(215) 755-6112',
      nursing: null,
      socialWork: null,
      medical: null
    },
    notes: 'Rehab 3.5B substance abuse treatment',
    tags: ['3.5B', 'Rehab', 'Substance Abuse']
  },
  {
    id: 'VALLEY_FORGE',
    ...
    email: null,
    website: null,
    services: ['Detox 3.7A', 'Detox 4.0A', 'Rehab 3.5B', 'Rehab 4.0B'],
    capabilities: {
      takes302: false,
      secureBh: false,
      acuteMed: false,
    ...
    contacts: {
      admissions: '(610) 539-8500',
      nursing: null,
      socialWork: null,
      medical: null
    },
    notes: 'Full spectrum LOC levels: Detox 3.7A, 4.0A and Rehab 3.5B, 4.0B',
    tags: ['3.7A', '4.0A', '3.5B', '4.0B', 'Detox', 'Rehab', 'Substance Abuse']
  },
  // ========== ADDITIONAL PSYCHIATRIC HOSPITALS ==========
  {
    id: 'MALVERN_SOUTH_PHILA',
    name: 'Malvern Treatment Center - South Philadelphia',
    category: 'Psychiatric Hospital',
    level: 'Inpatient Psychiatric',
    address: '1930 South Broad St',
    city: 'Philadelphia',
    ...
    phone: '(610) 480-8919',
    fax: '(484) 296-2999',
    email: 'MTCSouthPhilaAdmissions@malverntreatment.com',
    website: null,
    services: ['302 Accepted', 'CBH Insurance', 'Dual Diagnosis'],
    capabilities: {
      takes302: true,
      secureBh: false,
      acuteMed: false,
    ...
    contacts: {
      admissions: '(610) 480-8919',
      nursing: null,
      socialWork: null,
      medical: null
    },
    notes: 'Accepts 302, CBH insurance, dual diagnosis treatment',
    tags: ['302 Accepted', 'CBH Insurance', 'Dual Diagnosis']
  },
  {
    id: 'PRIME_LOWER_BUCKS',
    name: 'Prime Healthcare Lower Bucks',
    category: 'Psychiatric Hospital',
    level: 'Inpatient Psychiatric',
    ...
    contacts: {
      admissions: '(215) 785-9200',
      nursing: null,
      socialWork: null,
      medical: null
    },
    notes: 'Prime Healthcare system, accepts 302 and CBH insurance',
    tags: ['302 Accepted', 'CBH Insurance', 'Prime Healthcare']
  },
  {
    id: 'PRIME_ROXBOROUGH',
    name: 'Prime Healthcare Roxborough Hospital',
    category: 'Psychiatric Hospital',
    level: 'Inpatient Psychiatric',
  ...
  {
    id: 'TEMPLE_EPISCOPAL',
    name: 'Temple Hospital - Episcopal Campus',
    category: 'Psychiatric Hospital',
    level: 'Inpatient Psychiatric',
    address: '100 East Lehigh Ave',
    city: 'Philadelphia',
    state: 'PA',
    zip: '19125',
    phone: '(215) 707-1200',
    ...
    contacts: {
      admissions: '(215) 707-1200',
      nursing: null,
      socialWork: null,
      medical: null
    },
    notes: 'Temple Health system, accepts 302 and CBH insurance',
    tags: ['302 Accepted', 'CBH Insurance', 'Temple Health']
  }
];
